(defproject clojurescript-sandbox "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/clojurescript_sandbox.js"
                           :main clojurescript-sandbox.core
